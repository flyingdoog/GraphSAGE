...
class NodeMinibatchIterator(object):
    ...
    def __init__(self, adj_list, 
            placeholders, labels,
            batch_size=100, max_degree=25, train_mask= None, val_mask= None, test_mask= None,
            **kwargs):
        ...
        self.train_nodes = np.where(train_mask)[0]
        self.val_nodes = np.where(val_mask)[0]
        self.test_nodes = np.where(test_mask)[0]
